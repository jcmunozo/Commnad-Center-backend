...
from .models import WorkItemMilestone

CLOSED_TASK_STATUSES = ("DONE", "CANCELLED")


def milestone_progress(milestone: WorkItemMilestone) -> dict:
    """Derive status/progress of a WorkItemMilestone from its tasks — same
    rule as apps.projects.selectors.milestone_progress (Fase 1 #2)."""
